...
static const char col_blue[]        = "#182b47";
static const char col_blue2[]       = "#182a47";
static const char col_blue3[]       = "#203a63";
...
static const char *colors[][3]      = {
  ...
  [SchemeInfoNorm]  = { col_gray3, col_blue,   "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
};
