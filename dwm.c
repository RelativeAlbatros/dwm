...
//static void ch_kb_layout(const Arg *arg);
...
appiconsappend(char **str, const char *appicon, size_t new_size)
{
    ...
    strlcpy(temp_tag_name + 1, *str, strlen(*str));
    temp_tag_name[strlen(temp_tag_name)] = inner_separator;

    strlcpy(temp_tag_name + strlen(temp_tag_name),
...
// void
// ch_kb_layout(const Arg *arg)
// {
// 	char* nxt_layout = arg->v[current_kb_layout];
// 	system("setxkbmap");
// }
// 
int
