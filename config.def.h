...
static const char col_green[]       = "#00d371";
...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { col_verdo3, col_verdo2,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
    [SchemeTagsNorm]  = { col_gray3, col_verdo,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
